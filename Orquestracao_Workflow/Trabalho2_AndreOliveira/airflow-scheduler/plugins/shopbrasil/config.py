...
# Fila Celery — workers escutam esta fila (celery worker -q shopbrasil,default)
CELERY_QUEUE = "shopbrasil"
...
DEFAULT_ARGS = {
    ...
    # CeleryExecutor: todas as tasks desta DAG vão para a fila dos workers
    "queue": CELERY_QUEUE,
}
